  ...
  return (
    <>
      ...
      {isCloseLectureModalOpen && (
        <Modal
          onClose={() => setIsCloseLectureModalOpen(false)}
          isOpen={isCloseLectureModalOpen}
        >
          <div className="w-full h-full flex flex-col justify-center items-center space-y-4 text-2xl py-7">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="size-28 text-rose-500"
            >
              <path
                strokeLinecap="round"
...
export default CloseLectureButton;
